...
export class EarthquakeService {
  ...
  countTodayEarthquakes(): Observable<number> {
    return this.http.get<number>(`${this.baseUrl}/today/count`);
  }

  countLast7DaysEarthquakes(): Observable<number> {
    return this.http.get<number>(`${this.baseUrl}/last7days/count`);
  }

  countLast30DaysEarthquakes(): Observable<number> {
    return this.http.get<number>(`${this.baseUrl}/last30days/count`);
  }
}
